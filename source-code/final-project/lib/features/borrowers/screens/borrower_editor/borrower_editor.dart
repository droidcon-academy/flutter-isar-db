...
class BorrowerEditor extends StatelessWidget {
  ...
  const BorrowerEditor({super.key, this.borrower});
                        ...
                        RowColumnSwitch(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child:
                                  MembershipStartDateField(borrower: borrower),
                            ),
                            SizedBox(
                              width: buildColumn ? null : gap,
                              height: buildColumn ? gap : null,
                            ...
                            SizedBox(
                              width:
                                  buildColumn ? maxWidth : (maxWidth - gap) / 2,
                              child:
                                  MembershipDurationField(borrower: borrower),
                            ),
                          ],
                        ),
                        SizedBox(height: 32),
                        Center(
                          child: BorrowerAddUpdateButton(borrower: borrower),
                        ),
                      ],
                    );
                  },
